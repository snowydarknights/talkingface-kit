...
if __name__ == '__main__':
    ...
    parser.add_argument("--s_path", type=str, default='./data/crop_video/s.mp4')
    parser.add_argument("--full_path", type=str, default='./data/full_img/s/')
    parser.add_argument("--d_path", type=str, default='./data/d.mp4')
    parser.add_argument("--box_path", type=str, default='./data/crop_s.txt')
