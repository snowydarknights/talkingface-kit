...
if __name__ == '__main__':
    ...
    parser.add_argument("--s_path", type=str, default='./data/crop_video/s3.mp4')
    parser.add_argument("--full_path", type=str, default='./data/full_img/s3/')
    parser.add_argument("--d_path", type=str, default='./data/d3.mp4')
    parser.add_argument("--box_path", type=str, default='./data/crop_s3.txt')
